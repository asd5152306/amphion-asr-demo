const I18N = {
  zh: {
    ...
    "listen.p": "中英各 12 条。音频稍后放入仓库即可自动出现播放器；转写、热词表和对照结果已经就位。目标说话人请先听注册音频，再听混合音频。",
    "listen.loading": "正在载入样本…",
    "cite.title": "引用",
    "cite.p": "AmphionASR: Personalized Context-Aware Speech Recognition. Amphion Team, 2026.",
    "cite.copy": "复制 BibTeX",
    "cite.copied": "已复制",
    "foot.left": "Amphion Team · 音频 case 可稍后补入 audio/ 目录",
    "tab.all": "全部",
    "tab.hotword": "热词",
    ...
    "proto.all": "四类场景共用一个 1.7B 模型，只改指令和可选参考输入。音频文件稍后放入对应目录即可自动显示。",
    "zh": "中文",
    "en": "英文",
  },
  en: {
    ...
    "listen.p": "12 Mandarin and 12 English. Audio can be dropped in later; transcripts, hotword lists, and baselines are already here. For target-speaker cases, listen to enrollment first, then the mixture.",
    "listen.loading": "Loading cases…",
    "cite.title": "Cite",
    "cite.p": "AmphionASR: Personalized Context-Aware Speech Recognition. Amphion Team, 2026.",
    "cite.copy": "Copy BibTeX",
    "cite.copied": "Copied",
    "foot.left": "Amphion Team · drop audio files into audio/ later",
    "tab.all": "All",
    "tab.hotword": "Hotword",
    ...
    "proto.all": "Four settings, one 1.7B model; only the instruction and optional references change. Audio files will show up automatically once added.",
    "zh": "Chinese",
    "en": "English",
  },
};
